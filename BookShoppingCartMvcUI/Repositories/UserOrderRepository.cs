...
namespace BookShoppingCartMvcUI.Repositories
{
    public class UserOrderRepository : IUserOrderRepository
    {
        ...
        public async Task<Order?> GetOrderById(int id)
        {
            ...
            .Include(o => o.OrderDetail) // Thêm Include để lấy chi tiết đơn hàng nếu cần
        ...
        public async Task<IEnumerable<OrderDetail>> GetOrderDetailsByOrderId(int orderId)
        {
            return await _db.OrderDetails
                ...
                .Include(od => od.Book) // Bao gồm thông tin sách nếu cần
                .Include(od => od.Book.Genre) // Bao gồm thông tin thể loại sách nếu cần
                .ToListAsync();
        }
